...
mergeres1=mergeres1.rename(columns={"item":"Projects",'Spent time_x':"Spent Time",'Spent time_y':'Billable','Spent time':"Non Billable"})
print(mergeres1)
date_now=date.today()
mergeres1.to_excel(f"Project_report.xlsx",index=False)